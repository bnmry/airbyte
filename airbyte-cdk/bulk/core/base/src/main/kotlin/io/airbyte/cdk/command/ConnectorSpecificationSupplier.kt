 ...
 */
@Singleton
class ConnectorSpecificationSupplier<T : ConnectorSpecification>(
 ...
 * thinks that the [ConnectorSpecificationSupplier] requires a constructor argument of type [Any].
 *
 * Strictly speaking, its subclasses are not really POJOs anymore, but who cares.
 */
abstract class ConnectorSpecification
